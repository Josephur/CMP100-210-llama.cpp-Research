...
whose original candidate hunks were interleaved with rejected experiments. The
patches are ordered and independently auditable against the pinned upstream
...
576 excluded. Its loader-related and transport-related mixed hunks remain
excluded rather than being falsely relabeled as retained. Patches 0003 and
0004 are narrow source-level reconstructions against the pinned base. See the
